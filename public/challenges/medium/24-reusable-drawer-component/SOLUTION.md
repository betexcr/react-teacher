...
- `onClick={(e) => e.stopPropagation()}` — **onClick** — In "Build a Reusable Drawer Component", clicking runs when the user clicks this button. Portal mounts overlay at body; stopPropagation keeps drawer clicks from closing.
- `onClick={onClose}` — **onClick** — In "Build a Reusable Drawer Component", clicking runs when the user clicks this button. Portal mounts overlay at body; stopPropagation keeps drawer clicks from closing.
