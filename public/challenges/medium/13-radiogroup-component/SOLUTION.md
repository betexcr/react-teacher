...
- `onClick={() => onChange(o.value)}` — **onClick** — In "RadioGroup Component", clicking runs when the user clicks this button. Controlled value from parent; keyboard wraps selection index.
