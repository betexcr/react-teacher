...
- `onClick={onListClick}` — **onClick** — In "Event Delegation", clicking runs when the user clicks this button. React synthetic events still bubble; closest finds button with data attributes.
