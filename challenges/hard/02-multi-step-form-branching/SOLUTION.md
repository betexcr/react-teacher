...
- `onClick={goNext}` — **onClick** — In "Multi-step Form with Branching Logic", this runs when the user clicks this button. nextStep function encodes graph; UI renders step id; answers accumulate.
