...
- `onClick={download}` — **onClick** — In "Art Drawing Tool", this runs when the user clicks this button. Pointer events draw line segments; DPR effect sizes backing store for crisp strokes.
- `onClick={clear}` — **onClick** — In "Art Drawing Tool", this runs when the user clicks this button. Pointer events draw line segments; DPR effect sizes backing store for crisp strokes.
