...
- `onClick={addShape}` — **onClick** — In "State History Manager", this runs when the user clicks this button. SET pushes present to past and clears future. UNDO/REDO shift stacks.
