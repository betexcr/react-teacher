...
- `onClick={onFollow}` — **onClick** — In "Refactor to Props", this runs when the user clicks this button. UserCard becomes pure function of props. Gallery owns the list and wires events.
